...
// AFRF 
	if (_faction==5) then {
	_InfPool=	["rhs_msv_emr_aa","rhs_msv_emr_at","rhs_msv_emr_arifleman","rhs_msv_emr_efreitor","rhs_msv_emr_engineer","rhs_msv_emr_grenadier_rpg","rhs_msv_emr_strelok_rpg_assist","rhs_msv_emr_junior_sergeant","rhs_msv_emr_machinegunner","rhs_msv_emr_machinegunner_assistant","rhs_msv_emr_marksman","rhs_msv_emr_medic","rhs_msv_emr_officer_armored","rhs_msv_emr_rifleman","rhs_msv_emr_grenadier","rhs_msv_emr_LAT","rhs_msv_emr_RShG2","rhs_msv_emr_sergeant"];	
	_ArmPool=	["rhs_bmp1_tv","rhs_bmp1k_tv","rhs_bmp2e_tv","rhs_bmp2d_tv","rhs_brm1k_tv","rhs_prp3_tv","rhs_btr60_msv","rhs_btr70_msv","rhs_btr80_msv","rhs_btr80a_msv","rhs_bmp2k_tv","rhs_t80","rhs_t90a_tv","rhs_bmp3_late_msv","rhs_bmp3m_msv","rhs_bmp3_msv"];
	_MotPool=	["rhs_tigr_msv","rhs_tigr_3camo_msv","rhs_tigr_sts_msv","rhs_tigr_m_msv","rhs_tigr_m_3camo_msv","RHS_UAZ_MSV_01","rhs_uaz_open_MSV_01","rhs_gaz66_msv","rhs_gaz66o_msv","rhs_kamaz5350_msv","rhs_kamaz5350_open_msv","RHS_Ural_Open_MSV_01","rhs_zil131_msv","rhs_zil131_open_msv"];
	_ACHPool=	["RHS_Ka52_vvsc","RHS_Mi24P_vvsc","RHS_Mi24V_vvsc","RHS_Mi24Vt_vvsc"];
	_CHPool=	["rhs_ka60_c","RHS_Mi8AMT_vvsc","RHS_Mi8AMTSh_vvsc","RHS_Mi8mt_vvsc","RHS_Mi8mt_Cargo_vvsc","RHS_Mi8MTV3_vvsc","RHS_Mi8mtv3_Cargo_vvsc","RHS_Mi8MTV3_heavy_vvsc","RHS_Mi8T_vvsc"];
	_uavPool=	["rhs_pchela1t_vvsc"];
	_stPool=	["rhs_Metis_9k115_2_msv","rhs_Kornet_9M133_2_msv","rhs_Igla_AA_pod_msv","RHS_AGS30_TriPod_MSV","rhs_KORD_MSV","rhs_KORD_high_MSV","RHS_NSV_TriPod_MSV","rhs_SPG9M_MSV","RHS_ZU23_MSV","rhs_2b14_82mm_msv"];
	_shipPool=	["O_Boat_Armed_01_hmg_F","O_G_Boat_Transport_01_F"];
	_diverPool=	[];
	_crewPool=	["rhs_msv_emr_crew","rhs_msv_emr_armoredcrew","rhs_msv_emr_combatcrew","rhs_msv_emr_crew_commander"];
	_heliCrew=	["rhs_pilot_combat_heli"];
	};
	
// AFRF RECON 	
	if (_faction==6) then {
	_InfPool=	["rhs_vdv_recon_efreitor","rhs_vdv_recon_marksman","rhs_vdv_recon_marksman_asval","rhs_vdv_recon_marksman_vss","rhs_vdv_recon_rifleman_scout_akm","rhs_vdv_recon_rifleman_scout"];	
	_ArmPool=	[];
	_MotPool=	["rhs_tigr_vdv","rhs_tigr_3camo_vdv","rhs_tigr_m_vdv","rhs_tigr_m_3camo_vdv","rhs_uaz_vdv","rhs_uaz_open_vdv"];
	_ACHPool=	[];
	_CHPool=	[];
	_uavPool=	["rhs_pchela1t_vvsc"];
	_stPool=	[];
	_shipPool=	[];
	_diverPool=	["O_G_Boat_Transport_01_F"];
	_crewPool=	["rhs_msv_emr_crew","rhs_msv_emr_armoredcrew","rhs_msv_emr_combatcrew","rhs_msv_emr_crew_commander"];
	_heliCrew=	["rhs_pilot_combat_heli"];};
