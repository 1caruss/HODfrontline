...
GF_Missions_Debug_Markers				= false;					//	This script is reconfigured for debug porposes for the GF missions
GF_Missions_Show_Server_info			= false;					//	Show Server Systemchat information
GF_Missions_Systemchat_info				= false;					//	Show Systemchat information
GF_Missions_Hintsilent_info				= false;					//	Show Hint information
GF_Missions_Diag_Log_info				= false;					//	Log information
